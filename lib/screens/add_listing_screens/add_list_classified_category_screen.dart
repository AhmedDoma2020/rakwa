...
class AddListClassifiedCategoryScreen extends StatelessWidget {
                                  ...
                                  child: ScaleAnimation(
                                    child: FadeInAnimation(
                                      child: InkWell(
                                        onTap: () {
                                          ///
                                          // listController.changeCategory(index);
                                          // Get.to(() => AddListClassifiedSubCategoryScreen(id: snapshot.data![index].id));
                                        },
